...
>(({ className, onClick, ...props }, ref) => {
  ...
  const src =
    theme === 'dark' ? '/assets/icons/menu-dark.svg' : '/assets/icons/menu-light.svg'
  ...
  return (
    <Button
      ...
      {...props}
    >
      <Image alt="menu" src={src} width={32} height={32} />
    ...
    const button = (
      <Comp
        ...
        className={cn(
          ...
          'font-medium text-gray-600 hover:text-gray-900 active:text-gray-600 hover:bg-gray-100 active:bg-gray-50 transition-colors duration-200',
          className
        )}
        {...props}
      />
